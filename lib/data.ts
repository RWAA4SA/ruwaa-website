...
export const PROJECTS: Project[] = [
  ...
  {
    id: "dressing-room",
    title: "غرفة ملابس خاصة",
    titleEn: "Private Dressing Room",
    cat: "سكني خاص",
    catEn: "Residential",
    year: "٢٠٢٥",
    location: "المدينة المنورة",
    area: "١٨ م²",
    units: "غرفة ملابس متكاملة",
    cover: "/assets/portfolio/shot-03.png",
    summary:
      "غرفة ملابس متكاملة لأحد العملاء، بخزائن مضاءة من الداخل وجزيرة وسطية وإضاءة هادئة تُبرز الخامات، توازن بين السعة العملية والحضور البصري الأنيق.",
    role: "تصميم غرفة ملابس، اختيار خامات، مخططات نجارة",
    images: [
...
export const COMPANY_CAPABILITIES = [
  ...
  { n: "٠٣", t: "تخصيص نموذجي", d: "تصميم وحدات نموذجية قابلة للتكرار عبر عدة طوابق أو مواقع، مع ضبط جودة موحد.", meta: "تسريع دورة التصميم" },
...
// === خدمات الاستوديو الاحترافية (أسماء دائمة، لا مشاريع مؤقتة) ===
export type ServiceGroup = {
  group: string;
  groupEn: string;
  items: { t: string; en: string; d: string }[];
};

export const SERVICES: ServiceGroup[] = [
  {
    group: "التصميم الداخلي",
    groupEn: "Interior Design",
    items: [
      { t: "تصميم الفلل", en: "Villa Interior Design", d: "تصميم داخلي متكامل للفلل والقصور بلغة بصرية هادئة وخامات صادقة." },
      { t: "تصميم الشقق", en: "Apartment Interior Design", d: "حلول ذكية للمساحات السكنية توازن بين الجمال والوظيفة." },
      { t: "تصميم المجالس", en: "Majlis Design", d: "مجالس بطابع سعودي معاصر يجمع الضيافة بالأناقة." },
      { t: "تصميم غرف النوم", en: "Bedroom Design", d: "أجواء هادئة ومريحة مصممة حول راحتك وأسلوب حياتك." },
      { t: "تصميم غرف الملابس", en: "Walk-in Closet Design", d: "غرف ملابس منظّمة ومضاءة بعناية، تجمع السعة بالفخامة." },
      { t: "تصميم المطابخ", en: "Kitchen Design", d: "مطابخ عملية بتفاصيل نجارة دقيقة وإضاءة مدروسة." },
    ],
  },
  {
    group: "الضيافة والتجاري",
    groupEn: "Hospitality & Commercial",
    items: [
      { t: "تصميم الضيافة", en: "Hospitality Design", d: "فنادق ومنتجعات ومطاعم ومقاهٍ بهوية مكانية لا تُنسى." },
      { t: "التصميم التجاري", en: "Commercial Design", d: "مساحات تجارية تعزز الانطباع الأول وتخدم التجربة." },
      { t: "تصميم المكاتب", en: "Office Design", d: "بيئات عمل تعكس ثقافة الشركة وتدعم الإنتاجية." },
    ],
  },
  {
    ...
    items: [
      { t: "التخطيط المعماري", en: "Architectural Planning", d: "قراءة المكان وتوزيع الكتل والوظائف بكفاءة." },
      { t: "تخطيط المساحات", en: "Space Planning", d: "توزيع يوازن بين الحركة والخصوصية والسعة." },
      { t: "التصور ثلاثي الأبعاد", en: "3D Visualization", d: "مناظير واقعية ترى بها مساحتك قبل أن تُبنى." },
      { t: "المخططات التنفيذية", en: "Execution Drawings", d: "ملف كامل بمقاسات وتفاصيل جاهزة للمقاول." },
      { t: "الاستشارات التصميمية", en: "Design Consultation", d: "رأي متخصص يوجّه قراراتك ويحمي ميزانيتك." },
    ],
  },
];
