// === Site data: projects, services, copy ===
...
const PROJECTS = [
  {
    ...
    summary: "منتجع متوسط الحجم يستلهم خامته من الحجر الجيري والأخشاب الفاتحة، مع لمسات نباتية حية تذيب الحدود بين الداخل والخارج.",
  ...
  },
  {
    ...
    summary: "إعادة هندسة مساحات فيلا حديثة بلغة بصرية هادئة من المرمر والخشب الطبيعي، مع تركيز على الإضاءة الخفية والإيقاع الرأسي.",
  ...
  },
  {
    ...
    summary: "مجلس عائلي بطابع جزيري معاصر، يجمع بين النخيل الحقيقي وقبة سقفية متحررة من القوالب، مع أرضية خضراء تستحضر الواحة.",
  ...
  },
  {
    ...
    summary: "إعادة تصميم لوبي ومناطق إدارية في برج مكاتب، باستخدام إضاءة خطية وألواح خشبية مضيئة تخلق هوية بصرية موحدة عبر الطوابق.",
  ...
  },
  {
    ...
    summary: "مطبخ مفتوح بإضاءة بيضاوية ودهانات بنية، يوازن بين الدفء العائلي والصرامة المعمارية في تفاصيل الخزائن المعدنية.",
  ...
  },
  {
    ...
    summary: "جناح عافية ضمن منتجع متكامل، يستخدم الحجر الطبيعي والخشب الناعم لخلق حالة من الهدوء والخصوصية في كل غرفة علاج.",
...
const COMPANY_SERVICES = [
  ...
  { n: "04", t: "مشاريع التطوير العقاري", d: "شراكة طويلة مع المطورين منذ المخطط الهيكلي وحتى ملف التصميم النهائي لكل وحدة." },ي." },
